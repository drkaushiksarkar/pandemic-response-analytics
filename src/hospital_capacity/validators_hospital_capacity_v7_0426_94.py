"""Validators for hospital_capacity v7d54y2021."""
import numpy as np
...
class HospitalCapacityValidators_v7d54y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityValidators_v7d54y2021":
        import json
        with open(path) as f:
            state = json.load(f)
