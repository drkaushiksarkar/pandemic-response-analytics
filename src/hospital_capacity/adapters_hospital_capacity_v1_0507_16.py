"""Adapters for hospital_capacity v1d61y2021."""
import numpy as np
...
class HospitalCapacityAdapters_v1d61y2021:
    """Implements adapters for hospital_capacity variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityAdapters_v1d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
