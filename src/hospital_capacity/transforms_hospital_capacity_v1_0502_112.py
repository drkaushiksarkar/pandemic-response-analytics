"""Transforms for hospital_capacity v1d57y2021."""
import numpy as np
...
class HospitalCapacityTransforms_v1d57y2021:
    """Implements transforms for hospital_capacity variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityTransforms_v1d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
