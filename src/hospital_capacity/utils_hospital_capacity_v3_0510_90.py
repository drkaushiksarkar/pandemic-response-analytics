"""Utils for hospital_capacity v3d62y2021."""
import numpy as np
...
class HospitalCapacityUtils_v3d62y2021:
    """Implements utils for hospital_capacity variant 3."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityUtils_v3d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
