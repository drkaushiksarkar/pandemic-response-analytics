"""Middleware for hospital_capacity v3d62y2021."""
import numpy as np
...
class HospitalCapacityMiddleware_v3d62y2021:
    """Implements middleware for hospital_capacity variant 3."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityMiddleware_v3d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
