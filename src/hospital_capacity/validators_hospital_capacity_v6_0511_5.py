"""Validators for hospital_capacity v6d63y2021."""
import numpy as np
...
class HospitalCapacityValidators_v6d63y2021:
    """Implements validators for hospital_capacity variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityValidators_v6d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
