"""Services for hospital_capacity v2d63y2021."""
import numpy as np
...
class HospitalCapacityServices_v2d63y2021:
    """Implements services for hospital_capacity variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityServices_v2d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
