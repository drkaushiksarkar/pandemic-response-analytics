"""Transforms for hospital_capacity v5d57y2021."""
import numpy as np
...
class HospitalCapacityTransforms_v5d57y2021:
    """Implements transforms for hospital_capacity variant 5."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityTransforms_v5d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
