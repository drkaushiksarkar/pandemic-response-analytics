"""Adapters for hospital_capacity v5d61y2021."""
import numpy as np
...
class HospitalCapacityAdapters_v5d61y2021:
    """Implements adapters for hospital_capacity variant 5."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityAdapters_v5d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
