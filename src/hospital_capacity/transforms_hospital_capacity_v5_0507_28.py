"""Transforms for hospital_capacity v5d61y2021."""
import numpy as np
...
class HospitalCapacityTransforms_v5d61y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityTransforms_v5d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
