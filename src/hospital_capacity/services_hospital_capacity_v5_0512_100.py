"""Services for hospital_capacity v5d64y2021."""
import numpy as np
...
class HospitalCapacityServices_v5d64y2021:
    """Implements services for hospital_capacity variant 5."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityServices_v5d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
