"""Utils for hospital_capacity v5d64y2021."""
import numpy as np
...
class HospitalCapacityUtils_v5d64y2021:
    """Implements utils for hospital_capacity variant 5."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityUtils_v5d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
