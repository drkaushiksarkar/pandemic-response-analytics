"""Middleware for hospital_capacity v3d54y2021."""
import numpy as np
...
class HospitalCapacityMiddleware_v3d54y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityMiddleware_v3d54y2021":
        import json
        with open(path) as f:
            state = json.load(f)
