"""Services for hospital_capacity v6d63y2021."""
import numpy as np
...
class HospitalCapacityServices_v6d63y2021:
    """Implements services for hospital_capacity variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityServices_v6d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
