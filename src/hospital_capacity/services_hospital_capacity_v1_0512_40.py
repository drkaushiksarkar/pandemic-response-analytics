"""Services for hospital_capacity v1d64y2021."""
import numpy as np
...
class HospitalCapacityServices_v1d64y2021:
    """Implements services for hospital_capacity variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityServices_v1d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
