"""Middleware for hospital_capacity v8d59y2021."""
import numpy as np
...
class HospitalCapacityMiddleware_v8d59y2021:
    """Implements middleware for hospital_capacity variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "HospitalCapacityMiddleware_v8d59y2021":
        import json
        with open(path) as f:
            state = json.load(f)
