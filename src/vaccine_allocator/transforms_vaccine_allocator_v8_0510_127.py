"""Transforms for vaccine_allocator v8d62y2021."""
import numpy as np
...
class VaccineAllocatorTransforms_v8d62y2021:
    """Implements transforms for vaccine_allocator variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorTransforms_v8d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
