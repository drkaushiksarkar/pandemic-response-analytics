"""Validators for vaccine_allocator v2d57y2021."""
import numpy as np
...
class VaccineAllocatorValidators_v2d57y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorValidators_v2d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
