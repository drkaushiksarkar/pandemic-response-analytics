"""Validators for vaccine_allocator v2d61y2021."""
import numpy as np
...
class VaccineAllocatorValidators_v2d61y2021:
    """Implements validators for vaccine_allocator variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorValidators_v2d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
