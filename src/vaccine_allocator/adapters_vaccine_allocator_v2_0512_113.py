"""Adapters for vaccine_allocator v2d64y2021."""
import numpy as np
...
class VaccineAllocatorAdapters_v2d64y2021:
    """Implements adapters for vaccine_allocator variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorAdapters_v2d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
