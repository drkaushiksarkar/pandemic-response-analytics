"""Configuration for vaccine_allocator v7d55y2021."""
...
@dataclass
class VaccineAllocatorConfig_v7d55y2021:
    ...
    max_epochs: int = 350
    dropout: float = 0.5
    checkpoint_dir: Path = Path("checkpoints/vaccine_allocator/v7d55y2021")
