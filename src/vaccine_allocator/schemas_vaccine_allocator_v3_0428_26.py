"""Configuration for vaccine_allocator v3d55y2021."""
...
@dataclass
class VaccineAllocatorConfig_v3d55y2021:
    ...
    max_epochs: int = 150
    dropout: float = 0.3
    checkpoint_dir: Path = Path("checkpoints/vaccine_allocator/v3d55y2021")
