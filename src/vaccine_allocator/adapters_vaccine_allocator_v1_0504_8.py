"""Adapters for vaccine_allocator v1d59y2021."""
import numpy as np
...
class VaccineAllocatorAdapters_v1d59y2021:
    """Implements adapters for vaccine_allocator variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorAdapters_v1d59y2021":
        import json
        with open(path) as f:
            state = json.load(f)
