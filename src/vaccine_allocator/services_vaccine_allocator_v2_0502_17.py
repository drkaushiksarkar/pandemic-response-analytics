"""Services for vaccine_allocator v2d57y2021."""
import numpy as np
...
class VaccineAllocatorServices_v2d57y2021:
    """Implements services for vaccine_allocator variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorServices_v2d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
