"""Transforms for vaccine_allocator v7d53y2021."""
import numpy as np
...
class VaccineAllocatorTransforms_v7d53y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorTransforms_v7d53y2021":
        import json
        with open(path) as f:
            state = json.load(f)
