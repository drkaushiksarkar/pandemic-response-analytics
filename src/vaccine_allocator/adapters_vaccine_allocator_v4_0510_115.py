"""Adapters for vaccine_allocator v4d62y2021."""
import numpy as np
...
class VaccineAllocatorAdapters_v4d62y2021:
    """Implements adapters for vaccine_allocator variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorAdapters_v4d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
