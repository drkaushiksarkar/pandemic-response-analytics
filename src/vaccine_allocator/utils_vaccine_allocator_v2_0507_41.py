"""Utils for vaccine_allocator v2d61y2021."""
import numpy as np
...
class VaccineAllocatorUtils_v2d61y2021:
    """Implements utils for vaccine_allocator variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorUtils_v2d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
