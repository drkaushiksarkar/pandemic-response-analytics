"""Middleware for vaccine_allocator v2d57y2021."""
import numpy as np
...
class VaccineAllocatorMiddleware_v2d57y2021:
    """Implements middleware for vaccine_allocator variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorMiddleware_v2d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
