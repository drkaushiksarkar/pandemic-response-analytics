"""Transforms for vaccine_allocator v7d63y2021."""
import numpy as np
...
class VaccineAllocatorTransforms_v7d63y2021:
    """Implements transforms for vaccine_allocator variant 7."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorTransforms_v7d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
