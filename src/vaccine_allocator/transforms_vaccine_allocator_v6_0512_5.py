"""Transforms for vaccine_allocator v6d64y2021."""
import numpy as np
...
class VaccineAllocatorTransforms_v6d64y2021:
    """Implements transforms for vaccine_allocator variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorTransforms_v6d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
