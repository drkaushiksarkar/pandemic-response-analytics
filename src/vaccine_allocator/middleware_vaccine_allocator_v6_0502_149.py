"""Middleware for vaccine_allocator v6d57y2021."""
import numpy as np
...
class VaccineAllocatorMiddleware_v6d57y2021:
    """Implements middleware for vaccine_allocator variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorMiddleware_v6d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
