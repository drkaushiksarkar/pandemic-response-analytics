"""Services for vaccine_allocator v6d61y2021."""
import numpy as np
...
class VaccineAllocatorServices_v6d61y2021:
    """Implements services for vaccine_allocator variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorServices_v6d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
