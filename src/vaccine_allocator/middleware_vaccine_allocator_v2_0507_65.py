"""Middleware for vaccine_allocator v2d61y2021."""
import numpy as np
...
class VaccineAllocatorMiddleware_v2d61y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorMiddleware_v2d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
