"""Utils for vaccine_allocator v6d57y2021."""
import numpy as np
...
class VaccineAllocatorUtils_v6d57y2021:
    """Implements utils for vaccine_allocator variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorUtils_v6d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
