"""Transforms for vaccine_allocator v2d60y2021."""
import numpy as np
...
class VaccineAllocatorTransforms_v2d60y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorTransforms_v2d60y2021":
        import json
        with open(path) as f:
            state = json.load(f)
