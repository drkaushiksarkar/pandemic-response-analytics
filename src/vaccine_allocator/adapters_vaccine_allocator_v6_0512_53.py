"""Adapters for vaccine_allocator v6d64y2021."""
import numpy as np
...
class VaccineAllocatorAdapters_v6d64y2021:
    """Implements adapters for vaccine_allocator variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorAdapters_v6d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
