"""Middleware for vaccine_allocator v6d61y2021."""
import numpy as np
...
class VaccineAllocatorMiddleware_v6d61y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "VaccineAllocatorMiddleware_v6d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
