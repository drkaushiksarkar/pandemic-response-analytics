"""Validators for genomic_lineage v8d57y2021."""
import numpy as np
...
class GenomicLineageValidators_v8d57y2021:
    """Implements validators for genomic_lineage variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "GenomicLineageValidators_v8d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
