"""Utils for genomic_lineage v8d57y2021."""
import numpy as np
...
class GenomicLineageUtils_v8d57y2021:
    """Implements utils for genomic_lineage variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "GenomicLineageUtils_v8d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
