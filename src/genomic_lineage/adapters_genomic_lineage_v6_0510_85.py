"""Adapters for genomic_lineage v6d62y2021."""
import numpy as np
...
class GenomicLineageAdapters_v6d62y2021:
    """Implements adapters for genomic_lineage variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "GenomicLineageAdapters_v6d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
