"""Adapters for genomic_lineage v8d64y2021."""
import numpy as np
...
class GenomicLineageAdapters_v8d64y2021:
    """Implements adapters for genomic_lineage variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "GenomicLineageAdapters_v8d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
