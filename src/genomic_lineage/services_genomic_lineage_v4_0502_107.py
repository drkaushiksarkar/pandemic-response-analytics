"""Services for genomic_lineage v4d57y2021."""
import numpy as np
...
class GenomicLineageServices_v4d57y2021:
    """Implements services for genomic_lineage variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "GenomicLineageServices_v4d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
