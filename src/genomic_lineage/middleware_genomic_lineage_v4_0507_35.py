"""Middleware for genomic_lineage v4d61y2021."""
import numpy as np
...
class GenomicLineageMiddleware_v4d61y2021:
    """Implements middleware for genomic_lineage variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "GenomicLineageMiddleware_v4d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
