"""Adapters for genomic_lineage v2d62y2021."""
import numpy as np
...
class GenomicLineageAdapters_v2d62y2021:
    """Implements adapters for genomic_lineage variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "GenomicLineageAdapters_v2d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
