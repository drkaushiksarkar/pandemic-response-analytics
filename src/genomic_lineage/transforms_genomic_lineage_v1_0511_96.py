"""Transforms for genomic_lineage v1d63y2021."""
import numpy as np
...
class GenomicLineageTransforms_v1d63y2021:
    """Implements transforms for genomic_lineage variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "GenomicLineageTransforms_v1d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
