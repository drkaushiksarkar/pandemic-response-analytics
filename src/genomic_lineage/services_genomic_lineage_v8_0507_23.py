"""Services for genomic_lineage v8d61y2021."""
import numpy as np
...
class GenomicLineageServices_v8d61y2021:
    """Implements services for genomic_lineage variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "GenomicLineageServices_v8d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
