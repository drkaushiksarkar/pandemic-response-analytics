"""Transforms for testing_optimizer v1d61y2021."""
import numpy as np
...
class TestingOptimizerTransforms_v1d61y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerTransforms_v1d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
