"""Services for testing_optimizer v5d64y2021."""
import numpy as np
...
class TestingOptimizerServices_v5d64y2021:
    """Implements services for testing_optimizer variant 5."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerServices_v5d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
