"""Validators for testing_optimizer v6d63y2021."""
import numpy as np
...
class TestingOptimizerValidators_v6d63y2021:
    """Implements validators for testing_optimizer variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerValidators_v6d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
