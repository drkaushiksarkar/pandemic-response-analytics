"""Transforms for testing_optimizer v1d57y2021."""
import numpy as np
...
class TestingOptimizerTransforms_v1d57y2021:
    """Implements transforms for testing_optimizer variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerTransforms_v1d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
