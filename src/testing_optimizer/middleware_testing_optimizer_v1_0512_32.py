"""Middleware for testing_optimizer v1d64y2021."""
import numpy as np
...
class TestingOptimizerMiddleware_v1d64y2021:
    """Implements middleware for testing_optimizer variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerMiddleware_v1d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
