"""Adapters for testing_optimizer v1d61y2021."""
import numpy as np
...
class TestingOptimizerAdapters_v1d61y2021:
    """Implements adapters for testing_optimizer variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerAdapters_v1d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
