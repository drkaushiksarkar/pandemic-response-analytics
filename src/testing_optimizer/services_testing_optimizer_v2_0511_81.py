"""Services for testing_optimizer v2d63y2021."""
import numpy as np
...
class TestingOptimizerServices_v2d63y2021:
    """Implements services for testing_optimizer variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerServices_v2d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
