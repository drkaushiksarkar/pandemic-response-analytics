"""Services for testing_optimizer v4d59y2021."""
import numpy as np
...
class TestingOptimizerServices_v4d59y2021:
    """Implements services for testing_optimizer variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerServices_v4d59y2021":
        import json
        with open(path) as f:
            state = json.load(f)
