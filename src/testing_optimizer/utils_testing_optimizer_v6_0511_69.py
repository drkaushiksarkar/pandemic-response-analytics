"""Utils for testing_optimizer v6d63y2021."""
import numpy as np
...
class TestingOptimizerUtils_v6d63y2021:
    """Implements utils for testing_optimizer variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerUtils_v6d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
