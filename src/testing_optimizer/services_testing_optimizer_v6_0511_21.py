"""Services for testing_optimizer v6d63y2021."""
import numpy as np
...
class TestingOptimizerServices_v6d63y2021:
    """Implements services for testing_optimizer variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerServices_v6d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
