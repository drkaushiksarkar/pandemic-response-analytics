"""Middleware for testing_optimizer v6d55y2021."""
import numpy as np
...
class TestingOptimizerMiddleware_v6d55y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerMiddleware_v6d55y2021":
        import json
        with open(path) as f:
            state = json.load(f)
