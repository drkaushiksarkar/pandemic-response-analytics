"""Validators for testing_optimizer v1d52y2021."""
import numpy as np
...
class TestingOptimizerValidators_v1d52y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerValidators_v1d52y2021":
        import json
        with open(path) as f:
            state = json.load(f)
