"""Utils for testing_optimizer v2d63y2021."""
import numpy as np
...
class TestingOptimizerUtils_v2d63y2021:
    """Implements utils for testing_optimizer variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerUtils_v2d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
