"""Utils for testing_optimizer v7d62y2021."""
import numpy as np
...
class TestingOptimizerUtils_v7d62y2021:
    """Implements utils for testing_optimizer variant 7."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerUtils_v7d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
