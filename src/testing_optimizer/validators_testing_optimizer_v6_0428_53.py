"""Validators for testing_optimizer v6d55y2021."""
import numpy as np
...
class TestingOptimizerValidators_v6d55y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "TestingOptimizerValidators_v6d55y2021":
        import json
        with open(path) as f:
            state = json.load(f)
