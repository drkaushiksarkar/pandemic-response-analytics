"""Utils for reproduction_number v4d61y2021."""
import numpy as np
...
class ReproductionNumberUtils_v4d61y2021:
    """Implements utils for reproduction_number variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ReproductionNumberUtils_v4d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
