"""Configuration for reproduction_number v1d55y2021."""
...
@dataclass
class ReproductionNumberConfig_v1d55y2021:
    ...
    max_epochs: int = 50
    dropout: float = 0.1
    checkpoint_dir: Path = Path("checkpoints/reproduction_number/v1d55y2021")
