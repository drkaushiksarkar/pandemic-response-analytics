"""Transforms for reproduction_number v4d64y2021."""
import numpy as np
...
class ReproductionNumberTransforms_v4d64y2021:
    """Implements transforms for reproduction_number variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ReproductionNumberTransforms_v4d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
