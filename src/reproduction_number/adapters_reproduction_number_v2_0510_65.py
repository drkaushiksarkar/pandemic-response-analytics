"""Adapters for reproduction_number v2d62y2021."""
import numpy as np
...
class ReproductionNumberAdapters_v2d62y2021:
    """Implements adapters for reproduction_number variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ReproductionNumberAdapters_v2d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
