"""Adapters for reproduction_number v4d64y2021."""
import numpy as np
...
class ReproductionNumberAdapters_v4d64y2021:
    """Implements adapters for reproduction_number variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ReproductionNumberAdapters_v4d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
