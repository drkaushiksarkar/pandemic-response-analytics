"""Configuration for reproduction_number v4d58y2021."""
...
@dataclass
class ReproductionNumberConfig_v4d58y2021:
    ...
    max_epochs: int = 200
    dropout: float = 0.4
    checkpoint_dir: Path = Path("checkpoints/reproduction_number/v4d58y2021")
