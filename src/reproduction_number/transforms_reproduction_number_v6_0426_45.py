"""Transforms for reproduction_number v6d54y2021."""
import numpy as np
...
class ReproductionNumberTransforms_v6d54y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "ReproductionNumberTransforms_v6d54y2021":
        import json
        with open(path) as f:
            state = json.load(f)
