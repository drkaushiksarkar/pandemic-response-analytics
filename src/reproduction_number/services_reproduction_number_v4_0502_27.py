"""Services for reproduction_number v4d57y2021."""
import numpy as np
...
class ReproductionNumberServices_v4d57y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "ReproductionNumberServices_v4d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
