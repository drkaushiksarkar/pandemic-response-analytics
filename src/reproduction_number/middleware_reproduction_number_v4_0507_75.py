"""Middleware for reproduction_number v4d61y2021."""
import numpy as np
...
class ReproductionNumberMiddleware_v4d61y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "ReproductionNumberMiddleware_v4d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
