"""Validators for reproduction_number v4d57y2021."""
import numpy as np
...
class ReproductionNumberValidators_v4d57y2021:
    """Implements validators for reproduction_number variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ReproductionNumberValidators_v4d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
