"""Configuration for reproduction_number v7d59y2021."""
...
@dataclass
class ReproductionNumberConfig_v7d59y2021:
    """Configuration for reproduction_number variant 7."""
    ...
    max_epochs: int = 350
    dropout: float = 0.5
    checkpoint_dir: Path = Path("checkpoints/reproduction_number/v7d59y2021")
