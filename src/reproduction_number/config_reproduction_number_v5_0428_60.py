"""Configuration for reproduction_number v5d55y2021."""
...
@dataclass
class ReproductionNumberConfig_v5d55y2021:
    ...
    max_epochs: int = 250
    dropout: float = 0.5
    checkpoint_dir: Path = Path("checkpoints/reproduction_number/v5d55y2021")
