"""Services for reproduction_number v4d61y2021."""
import numpy as np
...
class ReproductionNumberServices_v4d61y2021:
    """Implements services for reproduction_number variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ReproductionNumberServices_v4d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
