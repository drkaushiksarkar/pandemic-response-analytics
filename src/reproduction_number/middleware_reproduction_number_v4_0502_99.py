"""Middleware for reproduction_number v4d57y2021."""
import numpy as np
...
class ReproductionNumberMiddleware_v4d57y2021:
    """Implements middleware for reproduction_number variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ReproductionNumberMiddleware_v4d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
