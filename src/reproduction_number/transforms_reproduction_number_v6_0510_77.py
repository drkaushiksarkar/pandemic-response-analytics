"""Transforms for reproduction_number v6d62y2021."""
import numpy as np
...
class ReproductionNumberTransforms_v6d62y2021:
    """Implements transforms for reproduction_number variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ReproductionNumberTransforms_v6d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
