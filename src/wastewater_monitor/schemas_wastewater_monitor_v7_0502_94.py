"""Configuration for wastewater_monitor v7d57y2021."""
...
@dataclass
class WastewaterMonitorConfig_v7d57y2021:
    """Configuration for wastewater_monitor variant 7."""
    ...
    max_epochs: int = 350
    dropout: float = 0.5
    checkpoint_dir: Path = Path("checkpoints/wastewater_monitor/v7d57y2021")
