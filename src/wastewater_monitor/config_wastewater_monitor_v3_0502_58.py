"""Configuration for wastewater_monitor v3d57y2021."""
...
@dataclass
class WastewaterMonitorConfig_v3d57y2021:
    ...
    max_epochs: int = 150
    dropout: float = 0.3
    checkpoint_dir: Path = Path("checkpoints/wastewater_monitor/v3d57y2021")
