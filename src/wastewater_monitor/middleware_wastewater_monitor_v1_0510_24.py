"""Middleware for wastewater_monitor v1d62y2021."""
import numpy as np
...
class WastewaterMonitorMiddleware_v1d62y2021:
    """Implements middleware for wastewater_monitor variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "WastewaterMonitorMiddleware_v1d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
