"""Adapters for wastewater_monitor v7d57y2021."""
import numpy as np
...
class WastewaterMonitorAdapters_v7d57y2021:
    """Implements adapters for wastewater_monitor variant 7."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "WastewaterMonitorAdapters_v7d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
