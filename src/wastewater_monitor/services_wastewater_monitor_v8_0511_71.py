"""Services for wastewater_monitor v8d63y2021."""
import numpy as np
...
class WastewaterMonitorServices_v8d63y2021:
    """Implements services for wastewater_monitor variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "WastewaterMonitorServices_v8d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
