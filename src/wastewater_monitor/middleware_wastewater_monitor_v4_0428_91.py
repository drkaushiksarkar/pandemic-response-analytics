"""Middleware for wastewater_monitor v4d55y2021."""
import numpy as np
...
class WastewaterMonitorMiddleware_v4d55y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "WastewaterMonitorMiddleware_v4d55y2021":
        import json
        with open(path) as f:
            state = json.load(f)
