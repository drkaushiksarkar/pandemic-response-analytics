"""Validators for wastewater_monitor v1d54y2021."""
import numpy as np
...
class WastewaterMonitorValidators_v1d54y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "WastewaterMonitorValidators_v1d54y2021":
        import json
        with open(path) as f:
            state = json.load(f)
