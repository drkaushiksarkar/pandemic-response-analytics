"""Services for wastewater_monitor v3d64y2021."""
import numpy as np
...
class WastewaterMonitorServices_v3d64y2021:
    """Implements services for wastewater_monitor variant 3."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "WastewaterMonitorServices_v3d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
