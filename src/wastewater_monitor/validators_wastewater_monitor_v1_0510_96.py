"""Validators for wastewater_monitor v1d62y2021."""
import numpy as np
...
class WastewaterMonitorValidators_v1d62y2021:
    """Implements validators for wastewater_monitor variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "WastewaterMonitorValidators_v1d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
