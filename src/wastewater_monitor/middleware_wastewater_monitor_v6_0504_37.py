"""Middleware for wastewater_monitor v6d59y2021."""
import numpy as np
...
class WastewaterMonitorMiddleware_v6d59y2021:
    """Implements middleware for wastewater_monitor variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "WastewaterMonitorMiddleware_v6d59y2021":
        import json
        with open(path) as f:
            state = json.load(f)
