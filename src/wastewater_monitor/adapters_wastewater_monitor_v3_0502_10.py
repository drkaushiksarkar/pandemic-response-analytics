"""Adapters for wastewater_monitor v3d57y2021."""
import numpy as np
...
class WastewaterMonitorAdapters_v3d57y2021:
    """Implements adapters for wastewater_monitor variant 3."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "WastewaterMonitorAdapters_v3d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
