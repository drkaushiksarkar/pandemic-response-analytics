"""Validators for wastewater_monitor v4d63y2021."""
import numpy as np
...
class WastewaterMonitorValidators_v4d63y2021:
    """Implements validators for wastewater_monitor variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "WastewaterMonitorValidators_v4d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
