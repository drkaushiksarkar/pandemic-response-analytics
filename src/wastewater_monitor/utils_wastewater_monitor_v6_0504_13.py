"""Utils for wastewater_monitor v6d59y2021."""
import numpy as np
...
class WastewaterMonitorUtils_v6d59y2021:
    """Implements utils for wastewater_monitor variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "WastewaterMonitorUtils_v6d59y2021":
        import json
        with open(path) as f:
            state = json.load(f)
