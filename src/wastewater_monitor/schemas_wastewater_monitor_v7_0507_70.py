"""Configuration for wastewater_monitor v7d61y2021."""
...
@dataclass
class WastewaterMonitorConfig_v7d61y2021:
    ...
    max_epochs: int = 350
    dropout: float = 0.5
    checkpoint_dir: Path = Path("checkpoints/wastewater_monitor/v7d61y2021")
