"""Services for variant_tracker v8d59y2021."""
import numpy as np
...
class VariantTrackerServices_v8d59y2021:
    """Implements services for variant_tracker variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerServices_v8d59y2021":
        import json
        with open(path) as f:
            state = json.load(f)
