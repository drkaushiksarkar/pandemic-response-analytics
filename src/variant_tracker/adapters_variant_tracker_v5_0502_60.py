"""Adapters for variant_tracker v5d57y2021."""
import numpy as np
...
class VariantTrackerAdapters_v5d57y2021:
    """Implements adapters for variant_tracker variant 5."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerAdapters_v5d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
