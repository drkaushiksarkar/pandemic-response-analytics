"""Validators for variant_tracker v7d62y2021."""
import numpy as np
...
class VariantTrackerValidators_v7d62y2021:
    """Implements validators for variant_tracker variant 7."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerValidators_v7d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
