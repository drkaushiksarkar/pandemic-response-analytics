"""Utils for variant_tracker v5d64y2021."""
import numpy as np
...
class VariantTrackerUtils_v5d64y2021:
    """Implements utils for variant_tracker variant 5."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerUtils_v5d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
