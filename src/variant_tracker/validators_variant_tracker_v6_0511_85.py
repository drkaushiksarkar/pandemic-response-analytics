"""Validators for variant_tracker v6d63y2021."""
import numpy as np
...
class VariantTrackerValidators_v6d63y2021:
    """Implements validators for variant_tracker variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerValidators_v6d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
