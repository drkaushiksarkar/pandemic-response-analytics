"""Validators for variant_tracker v2d63y2021."""
import numpy as np
...
class VariantTrackerValidators_v2d63y2021:
    """Implements validators for variant_tracker variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerValidators_v2d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
