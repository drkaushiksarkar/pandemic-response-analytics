"""Middleware for variant_tracker v2d63y2021."""
import numpy as np
...
class VariantTrackerMiddleware_v2d63y2021:
    """Implements middleware for variant_tracker variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerMiddleware_v2d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
