"""Utils for variant_tracker v2d63y2021."""
import numpy as np
...
class VariantTrackerUtils_v2d63y2021:
    """Implements utils for variant_tracker variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerUtils_v2d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
