"""Middleware for variant_tracker v1d64y2021."""
import numpy as np
...
class VariantTrackerMiddleware_v1d64y2021:
    """Implements middleware for variant_tracker variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerMiddleware_v1d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
