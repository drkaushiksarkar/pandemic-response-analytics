"""Services for variant_tracker v6d63y2021."""
import numpy as np
...
class VariantTrackerServices_v6d63y2021:
    """Implements services for variant_tracker variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerServices_v6d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
