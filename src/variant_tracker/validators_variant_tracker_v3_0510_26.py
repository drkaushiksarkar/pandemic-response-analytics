"""Validators for variant_tracker v3d62y2021."""
import numpy as np
...
class VariantTrackerValidators_v3d62y2021:
    """Implements validators for variant_tracker variant 3."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerValidators_v3d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
