"""Transforms for variant_tracker v5d57y2021."""
import numpy as np
...
class VariantTrackerTransforms_v5d57y2021:
    """Implements transforms for variant_tracker variant 5."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerTransforms_v5d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
