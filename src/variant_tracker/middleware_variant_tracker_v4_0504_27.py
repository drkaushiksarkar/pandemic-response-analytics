"""Middleware for variant_tracker v4d59y2021."""
import numpy as np
...
class VariantTrackerMiddleware_v4d59y2021:
    """Implements middleware for variant_tracker variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerMiddleware_v4d59y2021":
        import json
        with open(path) as f:
            state = json.load(f)
