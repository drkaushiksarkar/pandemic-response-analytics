"""Transforms for variant_tracker v1d57y2021."""
import numpy as np
...
class VariantTrackerTransforms_v1d57y2021:
    """Implements transforms for variant_tracker variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "VariantTrackerTransforms_v1d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
