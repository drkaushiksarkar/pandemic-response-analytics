"""Adapters for contact_tracer v4d62y2021."""
import numpy as np
...
class ContactTracerAdapters_v4d62y2021:
    """Implements adapters for contact_tracer variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ContactTracerAdapters_v4d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
