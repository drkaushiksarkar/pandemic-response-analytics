"""Transforms for contact_tracer v2d64y2021."""
import numpy as np
...
class ContactTracerTransforms_v2d64y2021:
    """Implements transforms for contact_tracer variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ContactTracerTransforms_v2d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
