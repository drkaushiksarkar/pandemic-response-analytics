"""Services for contact_tracer v6d57y2021."""
import numpy as np
...
class ContactTracerServices_v6d57y2021:
    """Implements services for contact_tracer variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ContactTracerServices_v6d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
