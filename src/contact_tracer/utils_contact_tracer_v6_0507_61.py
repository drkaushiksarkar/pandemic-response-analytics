"""Utils for contact_tracer v6d61y2021."""
import numpy as np
...
class ContactTracerUtils_v6d61y2021:
    """Implements utils for contact_tracer variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ContactTracerUtils_v6d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
