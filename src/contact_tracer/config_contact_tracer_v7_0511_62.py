"""Configuration for contact_tracer v7d63y2021."""
...
@dataclass
class ContactTracerConfig_v7d63y2021:
    """Configuration for contact_tracer variant 7."""
    ...
    max_epochs: int = 350
    dropout: float = 0.5
    checkpoint_dir: Path = Path("checkpoints/contact_tracer/v7d63y2021")
