"""Middleware for contact_tracer v2d61y2021."""
import numpy as np
...
class ContactTracerMiddleware_v2d61y2021:
    """Implements middleware for contact_tracer variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ContactTracerMiddleware_v2d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
