"""Validators for contact_tracer v2d57y2021."""
import numpy as np
...
class ContactTracerValidators_v2d57y2021:
    """Implements validators for contact_tracer variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ContactTracerValidators_v2d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
