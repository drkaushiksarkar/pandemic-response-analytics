"""Middleware for contact_tracer v6d57y2021."""
import numpy as np
...
class ContactTracerMiddleware_v6d57y2021:
    """Implements middleware for contact_tracer variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ContactTracerMiddleware_v6d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
