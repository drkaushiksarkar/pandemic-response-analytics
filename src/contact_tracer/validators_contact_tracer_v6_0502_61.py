"""Validators for contact_tracer v6d57y2021."""
import numpy as np
...
class ContactTracerValidators_v6d57y2021:
    """Implements validators for contact_tracer variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ContactTracerValidators_v6d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
