"""Adapters for contact_tracer v5d59y2021."""
import numpy as np
...
class ContactTracerAdapters_v5d59y2021:
    """Implements adapters for contact_tracer variant 5."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ContactTracerAdapters_v5d59y2021":
        import json
        with open(path) as f:
            state = json.load(f)
