"""Transforms for contact_tracer v6d64y2021."""
import numpy as np
...
class ContactTracerTransforms_v6d64y2021:
    """Implements transforms for contact_tracer variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "ContactTracerTransforms_v6d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
