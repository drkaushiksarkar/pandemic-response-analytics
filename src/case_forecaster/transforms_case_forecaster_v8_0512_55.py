"""Transforms for case_forecaster v8d64y2021."""
import numpy as np
...
class CaseForecasterTransforms_v8d64y2021:
    """Implements transforms for case_forecaster variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterTransforms_v8d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
