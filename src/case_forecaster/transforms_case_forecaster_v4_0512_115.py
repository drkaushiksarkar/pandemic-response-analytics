"""Transforms for case_forecaster v4d64y2021."""
import numpy as np
...
class CaseForecasterTransforms_v4d64y2021:
    """Implements transforms for case_forecaster variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterTransforms_v4d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
