"""Services for case_forecaster v8d57y2021."""
import numpy as np
...
class CaseForecasterServices_v8d57y2021:
    """Implements services for case_forecaster variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterServices_v8d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
