"""Adapters for case_forecaster v1d63y2021."""
import numpy as np
...
class CaseForecasterAdapters_v1d63y2021:
    """Implements adapters for case_forecaster variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterAdapters_v1d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
