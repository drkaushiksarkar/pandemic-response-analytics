"""Validators for case_forecaster v4d61y2021."""
import numpy as np
...
class CaseForecasterValidators_v4d61y2021:
    """Implements validators for case_forecaster variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterValidators_v4d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
