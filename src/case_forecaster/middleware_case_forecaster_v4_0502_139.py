"""Middleware for case_forecaster v4d57y2021."""
import numpy as np
...
class CaseForecasterMiddleware_v4d57y2021:
    """Implements middleware for case_forecaster variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterMiddleware_v4d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
