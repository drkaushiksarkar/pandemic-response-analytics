"""Services for case_forecaster v4d61y2021."""
import numpy as np
...
class CaseForecasterServices_v4d61y2021:
    """Implements services for case_forecaster variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterServices_v4d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
