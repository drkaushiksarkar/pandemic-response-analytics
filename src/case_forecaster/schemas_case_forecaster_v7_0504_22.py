"""Configuration for case_forecaster v7d59y2021."""
...
@dataclass
class CaseForecasterConfig_v7d59y2021:
    """Configuration for case_forecaster variant 7."""
    ...
    max_epochs: int = 350
    dropout: float = 0.5
    checkpoint_dir: Path = Path("checkpoints/case_forecaster/v7d59y2021")
