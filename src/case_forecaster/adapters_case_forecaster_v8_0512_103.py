"""Adapters for case_forecaster v8d64y2021."""
import numpy as np
...
class CaseForecasterAdapters_v8d64y2021:
    """Implements adapters for case_forecaster variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterAdapters_v8d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
