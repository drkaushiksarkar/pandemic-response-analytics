"""Utils for case_forecaster v8d57y2021."""
import numpy as np
...
class CaseForecasterUtils_v8d57y2021:
    """Implements utils for case_forecaster variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterUtils_v8d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
