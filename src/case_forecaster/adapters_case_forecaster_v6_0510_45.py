"""Adapters for case_forecaster v6d62y2021."""
import numpy as np
...
class CaseForecasterAdapters_v6d62y2021:
    """Implements adapters for case_forecaster variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterAdapters_v6d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
