"""Middleware for case_forecaster v8d61y2021."""
import numpy as np
...
class CaseForecasterMiddleware_v8d61y2021:
    """Implements middleware for case_forecaster variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterMiddleware_v8d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
