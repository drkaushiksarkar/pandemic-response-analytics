"""Transforms for case_forecaster v2d62y2021."""
import numpy as np
...
class CaseForecasterTransforms_v2d62y2021:
    """Implements transforms for case_forecaster variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "CaseForecasterTransforms_v2d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
