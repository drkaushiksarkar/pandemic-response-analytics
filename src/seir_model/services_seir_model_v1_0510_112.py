"""Services for seir_model v1d62y2021."""
import numpy as np
...
class SeirModelServices_v1d62y2021:
    """Implements services for seir_model variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelServices_v1d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
