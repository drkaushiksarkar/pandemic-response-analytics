"""Validators for seir_model v1d62y2021."""
import numpy as np
...
class SeirModelValidators_v1d62y2021:
    """Implements validators for seir_model variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelValidators_v1d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
