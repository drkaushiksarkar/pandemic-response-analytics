"""Middleware for seir_model v2d59y2021."""
import numpy as np
...
class SeirModelMiddleware_v2d59y2021:
    """Implements middleware for seir_model variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelMiddleware_v2d59y2021":
        import json
        with open(path) as f:
            state = json.load(f)
