"""Transforms for seir_model v7d57y2021."""
import numpy as np
...
class SeirModelTransforms_v7d57y2021:
    """Implements transforms for seir_model variant 7."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelTransforms_v7d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
