"""Middleware for seir_model v3d64y2021."""
import numpy as np
...
class SeirModelMiddleware_v3d64y2021:
    """Implements middleware for seir_model variant 3."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelMiddleware_v3d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
