"""Validators for seir_model v8d63y2021."""
import numpy as np
...
class SeirModelValidators_v8d63y2021:
    """Implements validators for seir_model variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelValidators_v8d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
