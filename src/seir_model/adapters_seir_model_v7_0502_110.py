"""Adapters for seir_model v7d57y2021."""
import numpy as np
...
class SeirModelAdapters_v7d57y2021:
    """Implements adapters for seir_model variant 7."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelAdapters_v7d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
