"""Validators for seir_model v7d64y2021."""
import numpy as np
...
class SeirModelValidators_v7d64y2021:
    """Implements validators for seir_model variant 7."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelValidators_v7d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
