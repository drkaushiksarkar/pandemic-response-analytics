"""Services for seir_model v4d63y2021."""
import numpy as np
...
class SeirModelServices_v4d63y2021:
    """Implements services for seir_model variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelServices_v4d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
