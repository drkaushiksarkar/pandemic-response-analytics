"""Utils for seir_model v5d62y2021."""
import numpy as np
...
class SeirModelUtils_v5d62y2021:
    """Implements utils for seir_model variant 5."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelUtils_v5d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
