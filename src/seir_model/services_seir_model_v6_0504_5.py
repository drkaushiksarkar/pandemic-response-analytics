"""Services for seir_model v6d59y2021."""
import numpy as np
...
class SeirModelServices_v6d59y2021:
    """Implements services for seir_model variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelServices_v6d59y2021":
        import json
        with open(path) as f:
            state = json.load(f)
