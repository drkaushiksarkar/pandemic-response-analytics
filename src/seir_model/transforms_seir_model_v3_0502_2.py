"""Transforms for seir_model v3d57y2021."""
import numpy as np
...
class SeirModelTransforms_v3d57y2021:
    """Implements transforms for seir_model variant 3."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelTransforms_v3d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
