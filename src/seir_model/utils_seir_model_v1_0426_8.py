"""Utils for seir_model v1d54y2021."""
import numpy as np
...
class SeirModelUtils_v1d54y2021:
    """Implements utils for seir_model variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "SeirModelUtils_v1d54y2021":
        import json
        with open(path) as f:
            state = json.load(f)
