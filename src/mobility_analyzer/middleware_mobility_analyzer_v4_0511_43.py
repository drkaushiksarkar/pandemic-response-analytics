"""Middleware for mobility_analyzer v4d63y2021."""
import numpy as np
...
class MobilityAnalyzerMiddleware_v4d63y2021:
    """Implements middleware for mobility_analyzer variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "MobilityAnalyzerMiddleware_v4d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
