"""Validators for mobility_analyzer v2d59y2021."""
import numpy as np
...
class MobilityAnalyzerValidators_v2d59y2021:
    """Implements validators for mobility_analyzer variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "MobilityAnalyzerValidators_v2d59y2021":
        import json
        with open(path) as f:
            state = json.load(f)
