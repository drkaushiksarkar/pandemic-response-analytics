"""Adapters for mobility_analyzer v7d57y2021."""
import numpy as np
...
class MobilityAnalyzerAdapters_v7d57y2021:
    """Implements adapters for mobility_analyzer variant 7."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "MobilityAnalyzerAdapters_v7d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
