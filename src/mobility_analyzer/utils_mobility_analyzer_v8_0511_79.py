"""Utils for mobility_analyzer v8d63y2021."""
import numpy as np
...
class MobilityAnalyzerUtils_v8d63y2021:
    """Implements utils for mobility_analyzer variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "MobilityAnalyzerUtils_v8d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
