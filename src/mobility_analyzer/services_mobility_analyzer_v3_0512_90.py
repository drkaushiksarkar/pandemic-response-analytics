"""Services for mobility_analyzer v3d64y2021."""
import numpy as np
...
class MobilityAnalyzerServices_v3d64y2021:
    """Implements services for mobility_analyzer variant 3."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "MobilityAnalyzerServices_v3d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
