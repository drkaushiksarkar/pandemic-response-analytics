"""Services for mobility_analyzer v7d64y2021."""
import numpy as np
...
class MobilityAnalyzerServices_v7d64y2021:
    """Implements services for mobility_analyzer variant 7."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "MobilityAnalyzerServices_v7d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
