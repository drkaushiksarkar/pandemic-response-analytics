"""Utils for mobility_analyzer v1d62y2021."""
import numpy as np
...
class MobilityAnalyzerUtils_v1d62y2021:
    """Implements utils for mobility_analyzer variant 1."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "MobilityAnalyzerUtils_v1d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
