"""Validators for mobility_analyzer v1d54y2021."""
import numpy as np
...
class MobilityAnalyzerValidators_v1d54y2021:
    ...
    @classmethod
    def load_state(cls, path: str) -> "MobilityAnalyzerValidators_v1d54y2021":
        import json
        with open(path) as f:
            state = json.load(f)
