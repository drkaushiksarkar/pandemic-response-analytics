"""Services for mobility_analyzer v8d63y2021."""
import numpy as np
...
class MobilityAnalyzerServices_v8d63y2021:
    """Implements services for mobility_analyzer variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "MobilityAnalyzerServices_v8d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
