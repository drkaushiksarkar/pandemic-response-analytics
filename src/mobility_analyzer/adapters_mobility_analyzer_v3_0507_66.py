"""Adapters for mobility_analyzer v3d61y2021."""
import numpy as np
...
class MobilityAnalyzerAdapters_v3d61y2021:
    """Implements adapters for mobility_analyzer variant 3."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "MobilityAnalyzerAdapters_v3d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
