"""Transforms for quarantine_model v4d62y2021."""
import numpy as np
...
class QuarantineModelTransforms_v4d62y2021:
    """Implements transforms for quarantine_model variant 4."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelTransforms_v4d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
