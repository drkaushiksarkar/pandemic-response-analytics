"""Transforms for quarantine_model v7d63y2021."""
import numpy as np
...
class QuarantineModelTransforms_v7d63y2021:
    """Implements transforms for quarantine_model variant 7."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelTransforms_v7d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
