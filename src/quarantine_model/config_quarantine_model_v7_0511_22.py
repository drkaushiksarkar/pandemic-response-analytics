"""Configuration for quarantine_model v7d63y2021."""
...
@dataclass
class QuarantineModelConfig_v7d63y2021:
    """Configuration for quarantine_model variant 7."""
    ...
    max_epochs: int = 350
    dropout: float = 0.5
    checkpoint_dir: Path = Path("checkpoints/quarantine_model/v7d63y2021")
