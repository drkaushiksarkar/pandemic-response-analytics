"""Adapters for quarantine_model v3d63y2021."""
import numpy as np
...
class QuarantineModelAdapters_v3d63y2021:
    """Implements adapters for quarantine_model variant 3."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelAdapters_v3d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
