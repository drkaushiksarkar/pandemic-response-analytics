"""Adapters for quarantine_model v7d63y2021."""
import numpy as np
...
class QuarantineModelAdapters_v7d63y2021:
    """Implements adapters for quarantine_model variant 7."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelAdapters_v7d63y2021":
        import json
        with open(path) as f:
            state = json.load(f)
