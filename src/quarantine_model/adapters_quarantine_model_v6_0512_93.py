"""Adapters for quarantine_model v6d64y2021."""
import numpy as np
...
class QuarantineModelAdapters_v6d64y2021:
    """Implements adapters for quarantine_model variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelAdapters_v6d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
