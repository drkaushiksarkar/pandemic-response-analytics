"""Middleware for quarantine_model v2d57y2021."""
import numpy as np
...
class QuarantineModelMiddleware_v2d57y2021:
    """Implements middleware for quarantine_model variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelMiddleware_v2d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
