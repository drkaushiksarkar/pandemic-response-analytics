"""Services for quarantine_model v2d61y2021."""
import numpy as np
...
class QuarantineModelServices_v2d61y2021:
    """Implements services for quarantine_model variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelServices_v2d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
