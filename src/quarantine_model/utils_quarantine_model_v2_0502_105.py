"""Utils for quarantine_model v2d57y2021."""
import numpy as np
...
class QuarantineModelUtils_v2d57y2021:
    """Implements utils for quarantine_model variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelUtils_v2d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
