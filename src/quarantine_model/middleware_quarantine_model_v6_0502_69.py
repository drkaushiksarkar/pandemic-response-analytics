"""Middleware for quarantine_model v6d57y2021."""
import numpy as np
...
class QuarantineModelMiddleware_v6d57y2021:
    """Implements middleware for quarantine_model variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelMiddleware_v6d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
