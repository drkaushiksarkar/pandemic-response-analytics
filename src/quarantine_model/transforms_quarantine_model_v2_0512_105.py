"""Transforms for quarantine_model v2d64y2021."""
import numpy as np
...
class QuarantineModelTransforms_v2d64y2021:
    """Implements transforms for quarantine_model variant 2."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelTransforms_v2d64y2021":
        import json
        with open(path) as f:
            state = json.load(f)
