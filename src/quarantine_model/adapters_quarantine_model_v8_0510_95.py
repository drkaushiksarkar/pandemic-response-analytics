"""Adapters for quarantine_model v8d62y2021."""
import numpy as np
...
class QuarantineModelAdapters_v8d62y2021:
    """Implements adapters for quarantine_model variant 8."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelAdapters_v8d62y2021":
        import json
        with open(path) as f:
            state = json.load(f)
