"""Validators for quarantine_model v6d57y2021."""
import numpy as np
...
class QuarantineModelValidators_v6d57y2021:
    """Implements validators for quarantine_model variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelValidators_v6d57y2021":
        import json
        with open(path) as f:
            state = json.load(f)
