"""Utils for quarantine_model v6d61y2021."""
import numpy as np
...
class QuarantineModelUtils_v6d61y2021:
    """Implements utils for quarantine_model variant 6."""
    ...
    @classmethod
    def load_state(cls, path: str) -> "QuarantineModelUtils_v6d61y2021":
        import json
        with open(path) as f:
            state = json.load(f)
